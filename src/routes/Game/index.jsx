            ...
            {!isGameStarted && (
              <div className="wrapper" onClick={handleStartGame}>
                <a className="cta" href="#">
                  <span>START</span>
                  <span>
                    <svg width="50px" height="50px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            {isGameStarted && (
              <>
                ...
                <div className="radial-menu">
                  {upgrades.map(({ name, label, priceId }) => (
                    <div key={label} className="upgrade-button" onClick={() => upgrade(label, priceId)}>
                      <p>Melhorar {name}</p>
                      <div className="points-upgrade-container">
                        <span id={label}>10</span><img src="pontos.png" alt="Icone Pontos" className="pointsIcon" />
                      </div>
                    </div>
                  ))}
                </div>
